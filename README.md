...
needs to build the app *correctly* — the spec, the rules, and the
skills. You supply the prompts.
...
| Data layer | [`lib/`](lib/) | Prisma client, typed view-models, and `queries.ts` reads shared by all pages |
